...
## gets current date
current_date <- as.Date(Sys.time()) - 1 # data is from 2 days before the release date
# current_date <- as.Date("2022-01-10") # data is from 2 days before the release date

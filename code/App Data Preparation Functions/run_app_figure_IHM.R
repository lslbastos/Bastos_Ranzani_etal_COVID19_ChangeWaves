...
run_app_figure_IHM <- function(df) {
    library(tidyverse)
    ...
    # 
    # 
    # ggsave(paste0("output/Update/fig_plot_comb_IHM_", release_date,".png"),
    ...
    write_csv(df_covid_ihm_week, here::here("input", "app_data", "df_covid_ihm_week.csv.gz"))
    
    write_csv(df_covid_ihm_week_age, here::here("input", "app_data", "df_covid_ihm_week_age.csv.gz"))
